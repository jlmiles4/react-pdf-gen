...
**Fix:** Keep the element together with `wrap={false}`. On wrapping pages, add `minPresenceAhead={40}` to headings; on pages that don't wrap, rebalance or split the source page.
