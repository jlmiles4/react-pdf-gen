...
// On a wrapping Page, keep a heading with following content
<View wrap={false} minPresenceAhead={40}>...</View>

// Force page break before element
<View break>...</View>

// Repeat on every subpage generated by this wrapping Page
<View fixed>...</View>
```
...
- If render time spikes, profile image dimensions and repeated asset work first
