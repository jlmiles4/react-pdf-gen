...
`templates/` and `prompts/` look similar but serve different audiences. See [`docs/architecture/overview.md`](docs/architecture/overview.md#authoring-inputs-vs-build-inputs) for the distinction.
