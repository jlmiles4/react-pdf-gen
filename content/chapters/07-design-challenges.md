...
The `fixed` prop repeats this element on every physical page generated by its parent `<Page>`.
...
// Usage:
<Callout variant="tip">
  Use StyleSheet.create() for reusable named styles. It keeps them organized
